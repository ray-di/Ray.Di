...
- Runtime assisted injection
- Null object

Ray.DI 2.0 was first released in 2015. Since then, we have continued to support the latest PHP. It may drop support for PHP that has been deprecated, but it does not break backwards compatibility.
...
# Bindings
  ...
  * [Null Object Binding](#null-object-binding)
  * [Scopes](#scopes)
...
See more at [Ray.ObjectGrapher](https://github.com/koriym/Ray.ObjectGrapher)
...
*This documentation of the most part is taken from [Google Guice](https://github.com/google/guice/).*
